...
if(isset($_POST['delete'])){
  $name=explode(" ", $_POST['delete']);
  $pid=$name[1];
  $pdo = new PDO(DBCONNSTRING,DBUSER,DBPASS);
    $pdo->setAttribute(PDO:: ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
    $id = $_SESSION['userid'];
    $sql = "DELETE FROM cart WHERE userid=$id and productid=$pid";
    $result=$pdo->exec($sql);
    data();
}
...
<body>
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
            <a class="nav-link p-2 p-lg-3 active" href="cart.php">السلة</a>
            </li>
            <li class="nav-item">
  ...
  <section class="cart h-100 h-custom" style="background-color: #eee;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="d-flex ">
                          <i style="color:rgba(255, 166, 0, 0.949) ;"class="fa-solid fa-cart-shopping fa-2x me-2"></i>
                          <h5 class="mb-1 ">عربة التسوق</h5>
                          <form action="<?php $PHP_SELF ?>" method="POST">
                             <button class="ms-auto btn btn-info btn-block btn-lg text-white" style="background-color: rgba(255, 166, 0, 0.949); border: #132763; position: absolute; top: 12px;right: 16px;" type="submit" name="submit" >
                        ...
                        <div class="card-body">
                          <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center">
                              <div>
                                <img
                                  src="images/<?php echo $row2['name']?>"
                                  class="img-fluid rounded-3" alt="Shopping item" style="width: 65px;">
                              </div>
                              <div class="ms-3">
                                <h5><?php echo $row3['name'] ?></h5>
                                <p class="small mb-0"><?php echo $row3['description'] ?></p>
                              </div>
                            </div>
                            <div class="d-flex flex-row align-items-center">
                              <div style="width: 80px;">
                                <h5 class="mb-0 ms-2"><?php echo $row3['price'] ?></h5>
                              </div>
                              <form action="<?php $PHP_SELF ?>" method="POST">
                                <button style="color:rgba(255, 166, 0, 0.949);" name="delete" value="<?php echo 'delete '.$row3['id']?>">
