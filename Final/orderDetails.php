          ...
          <div class="collapse navbar-collapse" id="main">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              if($_SESSION['accountType']=="customer"){
                ...
                <a class="nav-link p-2 p-lg-3 " href="customer.php">Profile</a>
              </li>';
              }
              else{
              	echo '<li class="nav-item">
                <a class="nav-link p-2 p-lg-3 " href="market.php">Profile</a>
              </li>';
              }
              ?>
              <li class="nav-item">
        ...
        <table class="table">
          <thead >
            <tr >
              ...
              <th class="p-3"scope="col">اسم المتجر</th>
          ...
          <tbody>
            <?php 
              ...
              $sql="SELECT * FROM trackings WHERE userid=$id AND order_id=$order_id";
              ...
              while ($row=$result->fetch()) {
                ...
                while ($row2=$result2->fetch()) {
                  ...
                  $sql6="SELECT u.name as userName FROM trackings as t inner join users as u inner join products as p where t.productid=".$row['productid']." AND t.productid=p.id and p.userID=u.id AND t.order_id=".$row['order_id'];
