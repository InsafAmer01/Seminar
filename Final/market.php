    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="main">
        ...
        <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link p-2 p-lg-3" href="addProduct.php">اضافة منتج</a>
              </li>
              <li class="nav-item">
    ...
    <section class="product py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-8">
                    <h1 class="display-5 fw-bolder"><?php echo $_SESSION['username']?></h1>
                    <div class="fs-5 mb-5">
                        <span><?php echo $_SESSION['useremail']?></span>
                    </div>
                    <div class="d-flex flex-column mb-3">
                        <p class="lead"><?php echo $_SESSION['useraddress']?></p>
                        <p class="lead"><?php echo $_SESSION['usernumber']?></p>
                    </div>
                    <div class="d-flex" >
                        <button class="btn ms-2 mb-3" type='button' onclick="location.href='addProduct.php';">
                            إضافة منتج
                            <i class="fa-solid fa-plus"></i>
                        </button>    
                        <button class="btn ms-2 mb-3" type='button'onclick="location.href='statics.php';">
                            انشاء تقرير 
                        ...
                        <button class="btn ms-2 mb-3" type='button'onclick="location.href='productList.php';">
                            قائمة المنتجات    
                            <i class="fa-solid fa-thumbtack"></i>
                        </button>
                    </div>
