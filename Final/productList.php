      ...
      <div class="card ">
        <table class="table">
            ...
            <tr >
              ...
              <th class="p-3"scope="col">اسم المنتج</th>
              <th class="p-3"scope="col">صورة المنتح</th>
              <th class="p-3"scope="col">السعر</th>
              <th class="p-3"scope="col">الكمية</th>
              <th class="p-3"scope="col">العلامة التجارية</th>
              <th class="p-3"scope="col">تعديل</th>
              <th class="p-3"scope="col">حذف</th>
            </tr>
          </thead>
          <tbody>
                <?php
