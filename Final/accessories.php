...
<body>
        ...
        <div class="container">
            ...
            <ul class="navbar-nav m-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                  ...
                  <a class="nav-link p-2 p-lg-3 active" href="accessories.php">مُكَمِّلات</a>
              </li>
            </ul>
            </div>    
        </div>
    ...
    <div class="products ">
      ...
      $sql = "SELECT * FROM products WHERE categoryName = 'accessories'";
