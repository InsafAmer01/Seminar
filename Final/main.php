    ...
    <div class="container">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link p-2 p-lg-3" href="login.php">تسجيل الدخول</a>
        </li>
      </ul>      
      </div>
  </nav>
    ...
    <div class="col-lg-4 mb-4 text-center text-md-start">
      <div class="text">
            ...
            <p class="text-black-50 fs-6">
             موقعنا متخصص في توفير قطع غيار سيارات عالية الجودة لعشاق السيارات والمهنيين.
