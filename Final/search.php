...
if (!empty($_POST['item'])) {
  $item = $_POST['item'];
  $sql .= " AND (name LIKE '%$item%' OR description LIKE '%$item%')";
}

if (!empty($_POST['carCondition'])) {
  $carCondition = $_POST['carCondition'];
  $sql .= " AND productType = '$carCondition'";
}

if (!empty($_POST['carBrand'])) {
  $carBrand = $_POST['carBrand'];
  $sql .= " AND brandName = '$carBrand'";
}
...
<body>
  ...
  <div class="search pt-1 pb-1 text-center text-md-start">
    <div class="container">
      <form class="row align-items-center" method="post" action="<?php echo $PHP_SELF?>">
          ...
          <div class="card w-100 my-2 ">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <?php 
                  ...
                  echo "<span><b>إنتهى من المخزن</b></span>";
                }
              ?>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-sm-4 col-md-4 mt-3 mb-3">
            ...
            <h4 class="mb-3 mt-3">Shipping in Palestine</h4>
            <p class="text-black-50 lh-lg">
              Power Wheels offers to ship any product to anywhere in Palestine.
            </p>
          </div>

          <div class="col-sm-4 col-md-4 mt-3 mb-3 ">
            <i class="icon fa-sharp fa-regular fa-hourglass-half"></i>
            <h4 class="mb-3 mt-3">Quick Delivery</h4>
            <p class="text-black-50 lh-lg">
              Power Wheels Make sure your product reaches you quickly and safely.
            </p>
          </div>

          <div class="col-sm-4 col-md-4 mt-3 mb-3">
            <i class="icon fa-solid fa-bell-concierge"></i>
            <h4 class="mb-3 mt-3">Great Customer Service</h4>
            <p class="text-black-50 lh-lg">
              Power Wheels ensures that you will receive the best customer service.
            </p>
          </div>
